				...
				<div class="row">
					<div class="col-12">
						<div class="header__content">
							<!-- header logo -->
							<a href="Home/index.html" class="header__logo">
							...
							<ul class="header__nav">
								...
								<li class="header__nav-item">
									...
									<ul class="dropdown-menu header__dropdown-menu" aria-labelledby="dropdownMenuHome">
										<li><a href="Home/index.html">Home slideshow bg</a></li>
										<li><a href="../Home/inicio.jsp">Home static bg</a></li>
									</ul>
								</li>
								<!-- end dropdown -->
								...
								<li class="header__nav-item">
									<a href="faq.jsp" class="header__nav-link header__nav-link--active">Help</a>
								</li>
								...
								<li class="dropdown header__nav-item">
									...
									<ul class="dropdown-menu header__dropdown-menu" aria-labelledby="dropdownMenuMore">
										...
										<li><a href="../Seguridad/signin.jsp">Sign In</a></li>
										<li><a href="../Seguridad/signup.jsp">Sign Up</a></li>
							...
							<div class="header__auth">
								...
								<a href="../Seguridad/signin.jsp" class="header__sign-in">
